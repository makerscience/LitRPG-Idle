...
export const ZONE_THEMES = {
  ...
  2: {
    ...
    treeRowOverrides: [
      ...
      { scaleRange: [0.2633, 0.3658], yRange: [0.8582, 0.8657], depth: -0.15, count: 3, speedMult: 1.0, depthSort: true },
      ...
      { scaleRange: [0.10, 0.15], yRange: [0.8656, 0.8805], depth: -0.145, count: 10, speedMult: 1.14, alpha: 0.7, keys: ['fog001'] },
      { scaleRange: [0.11, 0.165], yRange: [0.8656, 0.8805], depth: -0.145, count: 22, speedMult: 1.14, alpha: 0.7, keys: ['fog002', 'fog003'] },
