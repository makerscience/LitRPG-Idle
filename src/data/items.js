...
const ITEMS = {
  ...
  a1_rotfang_waterskin: {
    ...
    description: 'A slimy waterskin filled with syrupy green fluid. The contents appear to regenerate after a few seconds. Restores health on use. Taste profile: sour, with an unexpectedly sweet finish. Like candy. Probably fine to drink.',
    abbr: 'RfWS',
