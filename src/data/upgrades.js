...
const UPGRADES = [
  ...
  },
  {
    id: 'bigger_swigs',
    name: 'Bigger Swigs',
    description: '+20% drink healing effectiveness per level (max +100%)',
    group: 'stat',
    category: 'legit',
    currency: 'skillPoints',
    maxLevel: 5,
    requiresFlag: 'waterskinDrinkPopupShown',
    costFormula: () => 1,
    effect: { type: 'flat', target: 'waterskinHealBonusPct', valuePerLevel: 0.20 },
  },
  {
  ...
  },
  {
    id: 'smash_t3',
    name: 'Cataclysm',
    description: 'Power Smash cooldown reduced to 15s',
    group: 'skill',
    stance: 'ruin',
    category: 'legit',
    currency: 'skillPoints',
    ...
    requires: 'smash_t2',
    costFormula: () => 1,
    effect: { type: 'flag', target: 'smashCooldown15s' },
  },
