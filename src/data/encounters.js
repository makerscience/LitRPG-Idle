...
const ENCOUNTERS = [
  ...
  { id: 'a1_boar_duo', members: ['a1_thornback_boar', 'a1_thornback_boar'], weight: 1, zones: [6, 10], attackSpeedMult: 0.85, rewardMult: 1.3, lootBonus: { dropChanceMult: 1.15, rarityBoost: 0.02 } },
  ...
  { id: 'a1_boar_bird_mix', members: ['a1_thornback_boar', 'a1_bird'], weight: 2, zones: [7, 10], attackSpeedMult: 1.0, rewardMult: 1.25, lootBonus: { dropChanceMult: 1.08, rarityBoost: 0 } },
  ...
  { id: 'a1_boar_bandit_mix', members: ['a1_thornback_boar', 'a1_bandit'], weight: 2, zones: [9, 10], attackSpeedMult: 0.95, rewardMult: 1.32, lootBonus: { dropChanceMult: 1.12, rarityBoost: 0.01 } },
  ...
  { id: 'a2_beetle_scout_mix', members: ['a2_giant_beetle', 'a2_goblin_scout'], weight: 1, zones: [14, 15], attackSpeedMult: 0.95, rewardMult: 1.25, lootBonus: { dropChanceMult: 1.05, rarityBoost: 0.01 } },
